...
final class LoginViewController: UIViewController {
    ...
    private let switchRemember = UIButton()
    private let stackRemember = UIStackView()
    
    
    private var emailField = CustomTextField(authFieldType: .email)
    private var passwordField = CustomTextField(authFieldType: .password)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let checkImage = isCheck ? "switch" : "switchOff"
        switchRemember.setImage(UIImage(named: checkImage), for: .normal)
    }
    
    
    func setupSwitchButton() {
        switchRemember.heightAnchor.constraint(equalToConstant: 20).isActive = true
        switchRemember.widthAnchor.constraint(equalToConstant: 32).isActive = true
    ...
    @objc private func didTapSignIn() {
        ...
        if isCheck {
            defaults.set(loginRequest.email, forKey: "savedEmail")
            defaults.set(loginRequest.password, forKey: "savedPassword")
...
extension LoginViewController {
    ...
    func setupTextFields() {
        ...
        self.passwordField.setUpImage(imageName: "eyeClose", on: .right)
    }
...
extension LoginViewController {
    func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackBottomLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -32),
            stackBottomLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            stackBottomLabel.heightAnchor.constraint(equalToConstant: 32),
